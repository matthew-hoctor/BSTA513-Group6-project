...
Note from the above output that the second model, including the inverse square walking speed parameter but not grip strength transform, has the least deviance
...
EMM1 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    ...
    b1tbfkg + b1tblkg + giage1*mhstrk, data = step4_narm)
EMM2 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*mhpark, data = step4_narm)
EMM3 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*mhcopd, data = step4_narm)
EMM4 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*mharth, data = step4_narm)
EMM5 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*pascore, data = step4_narm)
EMM6 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*qlhealth, data = step4_narm)
EMM7 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*hwbmi, data = step4_narm)
EMM8 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*gsgrpavg, data = step4_narm)
EMM9 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*inv_sq_walk, data = step4_narm)
EMM10 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*b1fnd, data = step4_narm)
EMM11 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*b1tbfkg, data = step4_narm)
EMM12 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + giage1*b1tblkg, data = step4_narm)
EMM13 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*mhpark, data = step4_narm)
EMM14 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*mhcopd, data = step4_narm)
EMM15 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*mharth, data = step4_narm)
EMM16 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*pascore, data = step4_narm)
EMM17 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*qlhealth, data = step4_narm)
EMM18 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*hwbmi, data = step4_narm)
EMM19 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*gsgrpavg, data = step4_narm)
EMM20 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*inv_sq_walk, data = step4_narm)
EMM21 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*b1fnd, data = step4_narm)
EMM22 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*b1tbfkg, data = step4_narm)
EMM23 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhstrk*b1tblkg, data = step4_narm)
EMM24 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*mhcopd, data = step4_narm)
EMM25 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*mharth, data = step4_narm)
EMM26 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*pascore, data = step4_narm)
EMM27 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*qlhealth, data = step4_narm)
EMM28 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*hwbmi, data = step4_narm)
EMM29 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*gsgrpavg, data = step4_narm)
EMM30 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*inv_sq_walk, data = step4_narm)
EMM31 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*b1fnd, data = step4_narm)
EMM32 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*b1tbfkg, data = step4_narm)
EMM33 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhpark*b1tblkg, data = step4_narm)
EMM34 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*mharth, data = step4_narm)
EMM35 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*pascore, data = step4_narm)
EMM36 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*qlhealth, data = step4_narm)
EMM37 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*hwbmi, data = step4_narm)
EMM38 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*gsgrpavg, data = step4_narm)
EMM39 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*inv_sq_walk, data = step4_narm)
EMM40 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*b1fnd, data = step4_narm)
EMM41 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*b1tbfkg, data = step4_narm)
EMM42 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mhcopd*b1tblkg, data = step4_narm)
EMM43 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*pascore, data = step4_narm)
EMM44 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*qlhealth, data = step4_narm)
EMM45 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*hwbmi, data = step4_narm)
EMM46 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*gsgrpavg, data = step4_narm)
EMM47 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*inv_sq_walk, data = step4_narm)
EMM48 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*b1fnd, data = step4_narm)
EMM49 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*b1tbfkg, data = step4_narm)
EMM50 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + mharth*b1tblkg, data = step4_narm)
EMM51 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + pascore*qlhealth, data = step4_narm)
EMM52 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + pascore*hwbmi, data = step4_narm)
EMM53 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + pascore*gsgrpavg, data = step4_narm)
EMM54 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + pascore*inv_sq_walk, data = step4_narm)
EMM55 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + pascore*b1fnd, data = step4_narm)
EMM56 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + pascore*b1tbfkg, data = step4_narm)
EMM57 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + pascore*b1tblkg, data = step4_narm)
EMM58 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + qlhealth*hwbmi, data = step4_narm)
EMM59 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + qlhealth*gsgrpavg, data = step4_narm)
EMM60 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + qlhealth*inv_sq_walk, data = step4_narm)
EMM61 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + qlhealth*b1fnd, data = step4_narm)
EMM62 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + qlhealth*b1tbfkg, data = step4_narm)
EMM63 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + qlhealth*b1tblkg, data = step4_narm)
EMM64 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + hwbmi*gsgrpavg, data = step4_narm)
EMM65 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + hwbmi*inv_sq_walk, data = step4_narm)
EMM66 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + hwbmi*b1fnd, data = step4_narm)
EMM67 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + hwbmi*b1tbfkg, data = step4_narm)
EMM68 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + hwbmi*b1tblkg, data = step4_narm)
EMM69 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + gsgrpavg*inv_sq_walk, data = step4_narm)
EMM70 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + gsgrpavg*b1fnd, data = step4_narm)
EMM71 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + gsgrpavg*b1tbfkg, data = step4_narm)
EMM72 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + gsgrpavg*b1tblkg, data = step4_narm)
EMM73 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + inv_sq_walk*b1fnd, data = step4_narm)
EMM75 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + inv_sq_walk*b1tbfkg, data = step4_narm)
EMM76 <-
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth +
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd +
    b1tbfkg + b1tblkg + inv_sq_walk*b1tblkg, data = step4_narm)
EMM77 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + b1fnd*b1tbfkg, data = step4_narm)
EMM74 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + b1fnd*b1tblkg, data = step4_narm)
EMM78 <- 
  glm(formula = falls ~ giage1 + mhstrk + mhpark + mhcopd + mharth + 
    pascore + qlhealth + hwbmi + gsgrpavg + inv_sq_walk + b1fnd + 
    b1tbfkg + b1tblkg + b1tbfkg*b1tblkg, data = step4_narm)
...
```{r}
mod.qlhealth <- glm(formula = falls ~ qlh,
                    family = "binomial",
                    data = step4_narm)
summary(mod.qlhealth)
```
...
```{r}
hoslem.test(step4_narm$falls, fitted(preliminary_final_model), g=10)
```

The small p-value reported above suggests that the model does not fit well; however out sample size > 1000, and therefore the Hosmer-Lemeshow test is likely to reject the model even if the fit is adequate.
...
```{r}
gof(preliminary_final_model)$auc
```
