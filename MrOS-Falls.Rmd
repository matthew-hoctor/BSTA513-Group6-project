...
> Groups sizes for each unique value of each categorical variable
...
Since it's multilevel and categorical, it's computed seperately
...
## Step 3: Screen for confounders using the change in $\beta_i$ method. 
